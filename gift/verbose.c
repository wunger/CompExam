...
void v_enc_start128(uint64_t v_plainHigh, uint64_t v_plainLow)
{
    printf( "************************************\n" );
	printf( "Verbose output of GIFT-encryption\n" );
	printf( "************************************\n\n" );
	printf( "Given Ciphertext: %016"PRIx64" %016"PRIx64" \n", v_plainHigh, v_plainLow);
}
...
void v_dec_start128(uint64_t v_plainHigh, uint64_t v_plainLow)
{
    printf( "************************************\n" );
	printf( "Verbose output of GIFT-decryption\n" );
	printf( "************************************\n\n" );
...
void v_roundstart128(uint16_t v_round, uint64_t v_keyHigh, uint64_t v_keyLow)
{
	printf( "--------------------------------------\n" );
	printf( "Round %"PRIu16"\n", v_round );
...
void v_enc_final128(uint64_t  v_final_textHigh, uint64_t v_final_textLow, uint64_t v_keyHigh, uint64_t v_keyLow)
{
    printf( "--------------------------------------\n" );
	printf( "Final Round\n\n");
	printf( "Subkey: %016"PRIx64" %016"PRIx64"\n\n", v_keyHigh, v_keyLow );
	printf( "Text: %016"PRIx64" %016"PRIx64"\n\n", v_final_textHigh, v_final_textLow );
	v_final();
}
...
void v_after_xor128(uint64_t v_xorHigh, uint64_t v_xorLow)
{
...
void v_after_s128(uint64_t v_sHigh, uint64_t v_sLow)
{
...
void v_after_p128(uint64_t v_pHigh, uint64_t v_pLow)
{
